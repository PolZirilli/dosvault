...
const I18N = {
  es: {
    ...
    'ctrl.group.gamepad': 'Control',
    'ctrl.pressKey': 'Presioná una tecla...',
    'ctrl.unassigned': '— sin asignar —',

    'ctrl.padUp.label': 'Arriba',
    'ctrl.padDown.label': 'Abajo',
    'ctrl.padLeft.label': 'Izquierda',
    'ctrl.padRight.label': 'Derecha',
    'ctrl.fire1.label': 'Botón A (acción principal)',
    'ctrl.fire2.label': 'Botón B',
    'ctrl.fire3.label': 'Botón X',
    'ctrl.start.label': 'Start',
    'ctrl.select.label': 'Select',
    'ctrl.gamepad.none': 'Sin mando conectado',
    'ctrl.gamepad.detected': 'Mando detectado: {name}',
    'ctrl.gamepad.button': 'Botón {n}',
  ...
  en: {
    ...
    'ctrl.group.gamepad': 'Controller',
    'ctrl.pressKey': 'Press a key...',
    'ctrl.unassigned': '— unassigned —',

    'ctrl.padUp.label': 'Up',
    'ctrl.padDown.label': 'Down',
    'ctrl.padLeft.label': 'Left',
    'ctrl.padRight.label': 'Right',
    'ctrl.fire1.label': 'A button (primary action)',
    'ctrl.fire2.label': 'B button',
    'ctrl.fire3.label': 'X button',
    'ctrl.start.label': 'Start',
    'ctrl.select.label': 'Select',
    'ctrl.gamepad.none': 'No gamepad connected',
    'ctrl.gamepad.detected': 'Gamepad detected: {name}',
    'ctrl.gamepad.button': 'Button {n}',
